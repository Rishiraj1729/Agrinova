...
const en: Dict = {
  'app.name': 'AgriNova',
  'app.tagline': 'Turn Crop Residue into Income, Resources & Climate Impact.',
  'app.credit': 'Punjab CRM prototype',
  'nav.demo': 'List 5t straw',
  'hero.subtitle': 'Ramesh Singh has 12 days. Straw can be income — or smoke.',
  'disclaimer.demo': 'People and plants are fictional. MSP, straw yields, and PM2.5 context are labelled public or model estimates.',
  'nav.home': 'Home',
  'nav.farmer': 'Farmer',
